...
public final class IdCards {
    ...
    public static Date getBirthday2(String idCard) {
        ...
        return Dates.parse(birthday, DatePattern.PURE_DATE_PATTERN);
    }
    ...
    public static int getAge( String idCard) {
        return getAge(idCard, Dates.now());
    }
    ...
    public static int getAge( String idCard, Date comparedDate) {
        ...
        return Dates.age(birthday, comparedDate);
    }
    ...
    public static class IdCardVo implements Serializable {
        ...
        public IdCardVo(String idCard) {
            this.idCard = idCard;
            this.provinceCode = IdCards.getProvinceCode(idCard);
            this.cityCode = IdCards.getCityCode(idCard);
            this.districtCode = IdCards.getDistrictCode(idCard);
            this.gender = IdCards.getGender(idCard);
            this.age = IdCards.getAge(idCard);
        }
