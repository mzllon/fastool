...
public final class Charsets {
    ...
    public static Charset systemCharset() {
        return Files.isWindows() ? GBK : defaultCharset();
    }
    ...
    public static Charset forName(String charsetName, Charset defaultEncoding) {
        return Strings.isBlank(charsetName) ? defaultEncoding : Charset.forName(charsetName);
    }
    ...
    public static Charset getCharset(Charset encoding) {
        return getCharset(encoding, systemCharset());
    }
