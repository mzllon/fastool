...
public final class Classes {
    ...
    public static Class<?>[] getClasses(Object... values) {
        return java.util.Arrays.stream(Objects.requireNonNull(values))
    ...
    public static Object[] getDefaultValues(Class<?>[] parameterTypes) {
        return java.util.Arrays.stream(Objects.requireNonNull(parameterTypes))
                .map(Classes::getDefaultValue)
                .toArray(Object[]::new);
    }
    ...
    private static Class<?> getGenericType(Class<?> clazz, int index) {
        Type genericType = Types.getGenericType(clazz, index);
