...
public class Dates {
    ...
    public static String normalize(CharSequence dateStr) {
        ...
        List<String> resultList = Strings.splitToList(str, Chars.SPACE, true, true);
    ...
    public static Date tryParse(CharSequence dateCse) {
        ...
        if (Regexes.isMatch(DatePattern.REGEX_NORM, dateStr)) {
...
//        }
    ...
    public static int age(String birthday, String pattern, Date comparedDate) {
        String fmt = Strings.getIfEmpty(pattern, DatePattern.PURE_DATE_PATTERN);
